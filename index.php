        ...
        <div class="row gy-3">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <center><a href="login.php?role=warden" class="btn btn-primary">Warden Login</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <center><a href="login.php?role=student" class="btn btn-primary">Student Login</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <center><a href="login.php?role=security" class="btn btn-primary">Security Login</a></center>
                    </div>
                </div>
            </div>
        </div>
